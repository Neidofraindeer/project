												...
												<div class="col-1">
													<div class="travel_tour-billing-fields">
														...
														<select id="input_prefix" name="Name_pck" class="country_to_state country_select" style="margin-bottom: 0px;" required="">
                                                                ...
                                                                <option value="แพ็กเกจกระบี่ 3 วัน 2 คืน โรงแรม MONOTEL">แพ็กเกจกระบี่ 3 วัน 2 คืน โรงแรม BLUESOTEL อ่าวนาง</option>
					                                    </select>
														</p>
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <table id="tickets" class="table">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td><strong>เด็ก (4-10)</strong><a href="#" class="tooltip-1" data-placement="top" title="" data-original-title="9 - 15 years old"><sup class="icon-info-4"></sup></a><span class="price">2,000</span>
                                                                            </td>
                                                                            <td>
                                                                                <div class="styled-select">
