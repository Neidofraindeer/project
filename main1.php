...
<head>
	...
	<title>แพ็กเกจกระบี่ 3 วัน 2 คืน โรงแรม MONOTEL</title>
					...
					<div class="top_content_single row">
						<div class="images images_single_left">
							<div class="title-single">
								<div class="title">
									<h1>แพ็กเกจกระบี่ 3 วัน 2 คืน โรงแรม MONOTEL</h1>
								</div>
							</div>
							<div class="tour_after_title">
								<div class="meta_values">
									<span>Category:</span>
									<div class="value">
										<a href="#" rel="tag">แพ็กเกจ สิมิลัน 3 วัน 2 คืน</a>
									</div>
								</div>
							</div>
							<div id="slider" class="flexslider">
								<ul class="slides">
																		<li>
										<a href="assets/images/m1.jpg" class="swipebox" title=""><img src="assets/images/m1.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
																		<li>
										<a href="assets/images/m1.2.jpg" class="swipebox" title=""><img src="assets/images/m1.2.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
																		<li>
										<a href="assets/images/m1.3.jpg" class="swipebox" title=""><img src="assets/images/m1.3.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
																		<li>
										<a href="assets/images/m1.4.jpg" class="swipebox" title=""><img src="assets/images/m1.4.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
																		<li>
										<a href="assets/images/m1.5.jpg" class="swipebox" title=""><img src="assets/images/m1.5.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
																		<li>
										<a href="assets/images/m1.6.jpg" class="swipebox" title=""><img src="assets/images/m1.6.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" title="" draggable="false"></a>
									</li>
							...
							<div id="carousel" class="flexslider thumbnail_product">
								<ul class="slides">
																		<li>
										<img width="150" height="100" src="assets/images/m1.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
																		<li>
										<img width="150" height="100" src="assets/images/m1.2.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
																		<li>
										<img width="150" height="100" src="assets/images/m1.3.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
																		<li>
										<img width="150" height="100" src="assets/images/m1.4.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
																		<li>
										<img width="150" height="100" src="assets/images/m1.5.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
																		<li>
										<img width="150" height="100" src="assets/images/m1.6.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="" title="" draggable="false">
									</li>
								</ul>
							</div>
							...
							<div class="single-tour-tabs wc-tabs-wrapper">
								...
								<div class="tab-content">
									<div role="tabpanel" class="tab-pane single-tour-tabs-panel single-tour-tabs-panel--description panel entry-content wc-tab active" id="tab-description">
										...
										<p>						
											<div style="box-sizing: inherit; margin: 0px; padding: 0px; color: rgb(85, 85, 85); font-family: Roboto, Helvetica, Arial, sans-serif; font-size: 14px;">
                                            <img src="assets/images/KohSimilan.jpg"><br>
                                            </div>
										</p>
                                    </div>
